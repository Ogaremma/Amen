...
class FreeProductionDeploymentTests(unittest.TestCase):
    def test_github_workflow_exists_and_runs_daily_runner(self):
        ...
        self.assertIn("PREDICTION_DAILY_TOKEN: ${{ secrets.PREDICTION_DAILY_TOKEN }}", content)
        self.assertNotIn("FOREBET_INGESTION_TOKEN", content)
        self.assertNotIn("sportybet.com", content.lower())
