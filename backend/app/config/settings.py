...
class Settings(BaseSettings):
    ...
    forebet_challenge_cooldown_max_seconds: float = Field(default=21600.0, validation_alias="FOREBET_CHALLENGE_COOLDOWN_MAX_SECONDS", gt=0)
    ...
    forebet_browser_timeout: float = Field(default=20.0, validation_alias="FOREBET_BROWSER_TIMEOUT", gt=0, le=120)
