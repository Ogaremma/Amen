  ...
  return (
    <nav aria-label="Amen workspaces" className="mx-auto max-w-3xl rounded-3xl border border-white/10 bg-surface/80 p-3 shadow-glow backdrop-blur-xl sm:p-4">
      ...
      <button
        ...
        className={`flex min-h-24 items-center justify-center gap-2 rounded-2xl border px-3 text-center text-xs font-semibold uppercase tracking-[0.14em] transition sm:min-h-28 sm:text-sm ${active === 'optimizer' ? 'border-blue-300 bg-blue-600 text-white shadow-lg shadow-blue-500/30 ring-1 ring-blue-200/50' : 'border-white/10 bg-white/[0.03] text-slate-400 hover:border-blue-300 hover:bg-blue-600/20 hover:text-white hover:shadow-lg hover:shadow-blue-500/20'}`}
      >
      ...
      <button
        ...
        className={`flex min-h-24 items-center justify-center gap-2 rounded-2xl border px-3 text-center text-xs font-semibold uppercase tracking-[0.1em] transition sm:min-h-28 sm:text-sm ${active === 'analyzer' ? 'border-blue-300 bg-blue-600 text-white shadow-lg shadow-blue-500/30 ring-1 ring-blue-200/50' : 'border-white/10 bg-white/[0.03] text-slate-400 hover:border-blue-300 hover:bg-blue-600/20 hover:text-white hover:shadow-lg hover:shadow-blue-500/20'}`}
      >
        <BarChart3 className="h-4 w-4 shrink-0" />
        <span>Forebet Analyzer</span>
      </button>
      <button type="button" onClick={onFutureTool} className="flex min-h-24 flex-col items-center justify-center rounded-2xl border border-white/10 bg-white/[0.03] px-3 text-center transition hover:border-blue-300 hover:bg-blue-600/20 hover:shadow-lg hover:shadow-blue-500/20 sm:col-span-2 sm:min-h-24">
