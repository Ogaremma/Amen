...
export function WorkspaceNavigation({ active, onChange }: WorkspaceNavigationProps) {
  return (
    <nav aria-label="Amen workspaces" className="mx-auto max-w-3xl rounded-3xl border border-white/10 bg-surface/80 p-3 shadow-glow backdrop-blur-xl sm:p-4">
      ...
      <div className="flex min-h-24 flex-col items-center justify-center rounded-2xl border border-white/10 bg-white/[0.03] px-3 text-center sm:col-span-2 sm:min-h-24">
