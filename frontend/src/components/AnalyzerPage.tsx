...
void PrebookingDayCard

export function AnalyzerPage() {
  const [days, setDays] = useState<ForebetDrawWindowDay[]>([])
  const [compilation, setCompilation] = useState<ForebetDrawWindowDay | null>(null)
